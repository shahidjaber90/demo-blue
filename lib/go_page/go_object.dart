...
class GoObjectPage extends StatefulWidget {
  @override
  State<GoObjectPage> createState() => _GoObjectPageState();
}

class _GoObjectPageState extends State<GoObjectPage> {
