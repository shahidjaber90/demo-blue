...
class MyWidgetState extends State<MyWidgett> {
  ...
  void calculateAngles() {
    final double deltaX = tosx - posx;
    final double deltaY = tosy - posy;

    startAngles = atan2(deltaY, deltaX);
    endAngle = startAngles + 2 * pi;
  }
            ...
            child: Positioned(
              child: CustomPaint(
                  painter: CircleGraphPainter(
                      ...
                      endAngle: endAngle,
                      color: Colors.orange,
                      isFirstLineVisible: visible,
                      isSecondLineVisible: secondLineVisible)),
            ),
          ),
        ),
              ...
              onPanUpdate: (details) {
                ...
                if (box is RenderBox) {
                  ...
                  setState(() {
                    ...
                    print('start angle laal $startAngles');
                    calculateAngles();
                  });
                }
              },
...
class CircleGraphPainter extends CustomPainter {
  ...
  final Color color;
  final bool isFirstLineVisible;
  final bool isSecondLineVisible;

  CircleGraphPainter({
    required this.startAngle,
    required this.endAngle,
    required this.color,
    required this.isFirstLineVisible,
    required this.isSecondLineVisible,
  });
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (isFirstLineVisible) {
      // Draw the first line
      final startAngle = isFirstLineVisible;
      // ...
    }

    if (isSecondLineVisible) {
      // Draw the second line
      final endAngle = isSecondLineVisible;
      // ...
    }
  }
  ...
  bool shouldRepaint(CircleGraphPainter oldDelegate) =>
      ...
      isFirstLineVisible != oldDelegate.isFirstLineVisible ||
      isSecondLineVisible != oldDelegate.isSecondLineVisible;
}
